<div class="card" id="data">
    <div class="card-header p-2">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a type="button" class="nav-link active" data-toggle="modal" data-target="#NmyModal" id="addUsers">Add Permission</a>
            </li>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            @include('admin.permission.addform')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card-body">
        <div class="tab-content">
            <div class="active tab-pane" id="view">
                @include('admin.permission.includes.view')
            </div>
        </div>
    </div>
</div>
<script>
    ...
    $(document).on('submit', '#addPermission', function(e) {
        ...
        //Update user deatil
        $(document).on('submit', '#update_permission', function(e) {
            e.preventDefault();
            $('#page-loader').show();
            var formData = new FormData(this);
            $.ajax({
    ...
    function fetch_data(page) {
        ...
        var make_url = "{{route('permission.search')}}?page=" + page;
        $.ajax({
            url: make_url,
            data: data,
            success: function(data) {
